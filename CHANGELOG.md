...
- **Webview Preview Panel**: Immersive side-by-side prompt compilation panel including immediate Copy-To-Clipboard and Insert-Into-Active-Editor actions.
- **Workspace Customization**: Flexible settings parsing allowing users to specify custom prompt chains directly.
- **Shortcuts Mapping**: Responsive keybindings mapping on-cursor commands to keys (e.g. `Ctrl+Alt+R` for Review).
- **Esbuild Integration**: Single-file bundler setup for sub-millisecond execution launch.
